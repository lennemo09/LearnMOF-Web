...
class _ErrorMessage:
    ...
    INVALID_GOOGLE_TOKEN = "Token has been expired or revoked."
    FORBIDDEN = "Forbidden."
    NOT_FOUND = "Not found."
...
class InvalidGoogleToken(BaseError):
    status_code = StatusCode.UNAUTHORIZED
    error_code = _ErrorCode.INVALID_GOOGLE_TOKEN
    error_message = _ErrorMessage.INVALID_GOOGLE_TOKEN
